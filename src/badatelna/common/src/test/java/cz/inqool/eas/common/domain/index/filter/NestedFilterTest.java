...
class NestedFilterTest extends IndexFilterTestBase {
    ...
    void serialize() {
        Filter filter = new NestedFilter(
                ...
                new EqFilter(IndexFields.toManyRelationship + "." + key, entity_1.getToManyRelationship().get(0).getKey()).inNestedQuery()
        );
    ...
    void and_first() {
        ...
        params.addFilter(
                new NestedFilter(
                        ...
                        new AndFilter(
                                new EqFilter(IndexFields.toManyRelationship + "." + key, entity_1.getToManyRelationship().get(0).getKey()).inNestedQuery(),
                                new EqFilter(IndexFields.toManyRelationship + "." + value, entity_1.getToManyRelationship().get(0).getValue()).inNestedQuery()
                        )
                )
        );
    ...
    void and_second() {
        ...
        params.addFilter(
                new NestedFilter(
                        IndexFields.toManyRelationship,
                        new AndFilter(
                                new EqFilter(IndexFields.toManyRelationship + "." + key, entity_2.getToManyRelationship().get(1).getKey()).inNestedQuery(),
                                new EqFilter(IndexFields.toManyRelationship + "." + value, entity_2.getToManyRelationship().get(1).getValue()).inNestedQuery()
                        )
                )
        );
    ...
    void and_none() {
        ...
        params.addFilter(
                new NestedFilter(
                        ...
                        new AndFilter(
                                new EqFilter(IndexFields.toManyRelationship + "." + key, entity_1.getToManyRelationship().get(0).getKey()).inNestedQuery(),
                                new EqFilter(IndexFields.toManyRelationship + "." + value, entity_1.getToManyRelationship().get(1).getValue()).inNestedQuery()
                        )
                )
        );
