...
public class TermsAggregation extends BucketAggregation {
     ...
     *
     * @see <a href="https://www.elastic.co/guide/en/elasticsearch/reference/6.8/search-aggregations-bucket-terms-aggregation.html#search-aggregations-bucket-terms-aggregation-size">Size</a>
     */
    @Min(1)
     ...
     *
     * <a href="https://www.elastic.co/guide/en/elasticsearch/reference/6.8/search-aggregations-bucket-terms-aggregation.html#_shard_size_3">Shard
     * Size</a>
     */
    @Min(1)
     ...
     * term.
     *
     * <a href="https://www.elastic.co/guide/en/elasticsearch/reference/6.8/search-aggregations-bucket-terms-aggregation.html#_per_bucket_document_count_error">Per
     ...
     *
     * <a href="https://www.elastic.co/guide/en/elasticsearch/reference/6.8/search-aggregations-bucket-terms-aggregation.html#search-aggregations-bucket-terms-aggregation-order">Order</a>
     */
     ...
     *
     * <a href="https://www.elastic.co/guide/en/elasticsearch/reference/6.8/search-aggregations-bucket-terms-aggregation.html#_minimum_document_count_4">Minimum
     * document count</a>
     */
    @Min(1)
     ...
     *
     * <a href="https://www.elastic.co/guide/en/elasticsearch/reference/6.8/search-aggregations-bucket-terms-aggregation.html#_minimum_document_count_4">Shard
     ...
     *
     * <a href="https://www.elastic.co/guide/en/elasticsearch/reference/6.8/search-aggregations-bucket-terms-aggregation.html#search-aggregations-bucket-terms-aggregation-script">Script</a>
     */
     ...
     *
     * <a href="https://www.elastic.co/guide/en/elasticsearch/reference/6.8/search-aggregations-bucket-terms-aggregation.html#_filtering_values_3">Filtering
     * Values</a>
     */
     ...
     *
     * <a href="https://www.elastic.co/guide/en/elasticsearch/reference/6.8/search-aggregations-bucket-terms-aggregation.html#_collect_mode">Collect
     * mode</a>
     */
     ...
     *
     * <a href="https://www.elastic.co/guide/en/elasticsearch/reference/6.8/search-aggregations-bucket-terms-aggregation.html#search-aggregations-bucket-terms-aggregation-execution-hint">Execution
     * hint</a>
     */
     ...
     *
     * <a href="https://www.elastic.co/guide/en/elasticsearch/reference/6.8/search-aggregations-bucket-terms-aggregation.html#_missing_value_12">Missing
     * value</a>
     */
    ...
    @Builder
    public TermsAggregation(BucketAggregator aggregator, List<Aggregation> aggregations, String name, String field,
    ...
    public AggregationBuilder toAggregationBuilder(IndexObjectFields indexObjectFields) {
        ...
        if (field != null) {
            if (!indexObjectFields.containsKey(field)) {
                throw new InvalidAttribute(this.getClass(), null, field, FIELD_NOT_MAPPED);
            }
