...
abstract public class TextFilter extends FieldValueFilter {
    ...
    protected TextFilter(@NotNull String operation, @NotBlank String field, @NotBlank String value, Modifier modifier, boolean nestedQueryEnabled) {
