...
public class ManDetail extends cz.inqool.entityviews.abs.PersonDetail implements cz.inqool.entityviews.View {
    public int strength;
    ...
    public static void toEntity(Man entity, ManDetail view) {
        ...
        cz.inqool.entityviews.abs.PersonDetail.toEntity(entity, view);
    ...
    public static void toView(ManDetail view, Man entity) {
        ...
        cz.inqool.entityviews.abs.PersonDetail.toView(view, entity);
