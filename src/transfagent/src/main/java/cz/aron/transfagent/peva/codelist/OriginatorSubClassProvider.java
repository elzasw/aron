...
public class OriginatorSubClassProvider extends CodeProvider<Peva2OriginatorSubclass> {
	...
	public OriginatorSubClassProvider(PEvA peva2, Map<String, Peva2OriginatorSubclass> cached) {
		super(peva2, cached);
	}
	...
	public Peva2OriginatorSubclass downloadItem(String id) {
		...
		gosReq.setId(id);
		var gosResp = peva2.getOriginatorSubClass(gosReq);
	...
	public static OriginatorSubClassProvider create(PEvA peva2) {
