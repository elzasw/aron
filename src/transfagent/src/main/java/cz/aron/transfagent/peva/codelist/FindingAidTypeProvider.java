...
public class FindingAidTypeProvider extends CodeProvider<String> {
	...
	public FindingAidTypeProvider(PEvA2Connection peva2, Map<String, String> cached) {
		super(peva2, cached);
	}
	...
	public String downloadItem(String id) {
		...
		gfatReq.setId(id);
		var gfatResp = peva2.getPeva().getFindingAidType(gfatReq);
	...
	public static FindingAidTypeProvider create(PEvA2Connection peva2) {
		Map<String, String> ret = new HashMap<>();
		var lfatReq = new ListFindingAidTypeRequest();
		lfatReq.setSize(100);
		var lfatResp = peva2.getPeva().listFindingAidType(lfatReq);
