...
public class AccessibilityProvider extends CodeProvider<String> {
	...
	public AccessibilityProvider(PEvA peva2, Map<String, String> cache) {
		super(peva2, cache);
	}
	...
	public String downloadItem(String id) {
		...
		gaReq.setId(id);
		var gaResp = peva2.getAccessibility(gaReq);
	...
	public static AccessibilityProvider create(PEvA peva2) {
