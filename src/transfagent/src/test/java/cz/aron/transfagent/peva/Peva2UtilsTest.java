...
public class Peva2UtilsTest {
	...
	public void testParseDating() {		
		compareIdr(Peva2Utils.parseDating("1.1.2000", "type"),"2000-01-01T00:00:00","2000-01-01T23:59:59");				
		compareIdr(Peva2Utils.parseDating("1928", "type"),"1928-01-01T00:00:00","1928-12-31T23:59:59");
		compareIdr(Peva2Utils.parseDating("1.2.1996", "type"),"1996-02-01T00:00:00","1996-02-01T23:59:59");
	}
	
	private void compareIdr(ItemDateRange idr, String f, String t) {
